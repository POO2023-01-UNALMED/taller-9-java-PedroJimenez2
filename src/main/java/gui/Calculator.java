...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
		...
		if(b.getText().equals("=")) {
			String[] lisOperation = operation.split("(?=\\D)|(?<=\\D)");
			if(lisOperation[1].equals("+")) displayText.setText(String.valueOf(Double.parseDouble(lisOperation[0])+Double.parseDouble(lisOperation[2])));
			else if(lisOperation[1].equals("-")) displayText.setText(String.valueOf(Double.parseDouble(lisOperation[0])-Double.parseDouble(lisOperation[2])));
			else if(lisOperation[1].equals("*")) displayText.setText(String.valueOf(Double.parseDouble(lisOperation[0])*Double.parseDouble(lisOperation[2])));
			else if(lisOperation[1].equals("/")) displayText.setText(String.valueOf(Double.parseDouble(lisOperation[0])/Double.parseDouble(lisOperation[2])));
			operation="";
		}
